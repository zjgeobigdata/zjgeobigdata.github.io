import type { BarChartConfigType, BarChartDataType, GridType, LegendConfigType } from '../types';
declare const _sfc_main: import("vue").DefineComponent<{
    ...
    getAxisLabel: (args: any) => {
        axisLabel: any;
    };
    getSeries: (data: BarChartDataType[]) => {
        series: {
            type: string;
            color: string[];
            data: {
    ...
    getOptions: (data: BarChartDataType[], config: BarChartConfigType) => import("vue").Ref<{
        series: {
            type: string;
            color: string[];
            data: {
